...
use App\Models\packageMaster as Table;
use Illuminate\Http\Request;
use DB;

class packageMasterController extends Controller {
    protected $handle_name = 'package_master';
    protected $handle_name_plural = 'package_master';
    ...
    public function create() {
        ...
        $services = DB::table('service_cat_master')->get();
