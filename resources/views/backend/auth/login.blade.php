                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="login-form" method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="mb-3 form-check">
                                                <div class="utility">
                                                    <input type="checkbox" name="remember" class="form-check-input k-input"
                                                        id="remember">
                                                    <label class="form-check-label k-cursor"
                                                        for="remember">{{ __('Remember Me') }}</label>
                                                </div>
                                            </div>
                                            <div class="mb-2 d-grid gap-2">
                                                <button class="btn k-btn k-btn-primary btn-block"
                                            ...
                                            @if (Route::has('password.request'))
                                                <div class="mt-4 text-center">
                                                    <p class="semibold-text mb-2"><a href="{{ route('password.request') }}"
                                                            data-toggle="flip"
                                                            class="k-link">{{ __('Forgot Your Password?') }}</a></p>
                                                </div>
                                            @endif
                                        </form>
                                    </div>
