            ...
            <div class="col-md-12">
                            ...
                            <div class="col-7">
                                <div class="d-flex align-items-center">
                                    <div class="px-2 trash_selected_button bulk_select_btn">
                                        <button class="btn k-btn k-btn-primary trash_selected" name="trash_selected">Trash
                                            Selected</button>
                                    </div>
                                    <div class="px-2 restore_selected_button bulk_select_btn">
                                        <button class="btn k-btn k-btn-primary delete_selected"
                                            name="delete_selected">Delete Selected</button>
                                    </div>
                                    <div class="col-4">
                                        <input type="hidden" name="page_number" id="page_number" class="page_number"
                                            value="{{ $page_number }}">
                                        <div class="input-group pr-2">
                                            <input type="text" class="form-control k-input search" name="search"
                                ...
                                <div class="d-flex justify-content-end align-items-center">
                                    <div class="trashed px-2">
                                        <div class="input-group">
                                            ...
                                            <select class="custom-select form-select change_display"
                                                id="inputGroupSelect01">
                                                <option {{ $all_status }} value="all">All ({{ $all_count }})
                                                </option>
                                                <option {{ $trash_status }} value="trashed">Trashed ({{ $trashed_count }})
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="limit px-2">
                                        <div class="input-group">
                                            ...
                                            <select class="custom-select form-select change_row_limit"
                                                id="inputGroupSelect01">
                ...
                <div class="card">
                    <div class="card-body p-0">
                        <div class="ajax_loader p-3 text-center"><img
                                src="{{ asset('backend/assets/images/ajax_loader_circular.gif') }}" alt=""></div>
                        @if (session('status'))
                                    ...
                                    if (willDelete) {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(resp) {
                                                var res_msg =
                                                    "It has been trashed successfully.";
                                                swal(res_msg, {
                                                    icon: "success",
                                                }).then(function() {
                                                    location.reload();
