                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    @if ($edit)
                                        <div class="mb-3">
                                            ...
                                            <input type="password" name="old_password" autocomplete="new-password"
                                                class="form-control k-input" id="old_password"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" name="password" class="form-control k-input"
                                            id="new_password" aria-describedby="new_passwordHelp">
