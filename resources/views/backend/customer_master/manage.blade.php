                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="cust_name">Com Name</label>
                                        <input type="text" name="cust_name" class="form-control k-input" id="cust_name"
                                            @if ($edit) value="{{ $data->cust_name }}" @else value="{{ old('cust_name') }}" @endif>
                                    </div>
                                </div>
